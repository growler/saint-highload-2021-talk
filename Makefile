...
THEME_SOURCES = $(MEDIA_PATH)/beamerthemeshl2021.sty $(MEDIA_PATH)/itoolabs-graphics.sty $(MEDIA_PATH)/itoolabs-graphics.lua
...
clean:
	@find . -depth 1 -name \*.old -delete && \
	 find .latex-cache/ -depth 1 -name talk.\* -delete
